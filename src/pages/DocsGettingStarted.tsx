            ...
            <div className="lg:col-span-3">
              <Card className="glass p-8  border-border/50">
                ...
                <div className="space-y-6">
                  <section>
                    <h3 className="text-lg font-normal mb-3">Prerequisites</h3>
                    <ul className="space-y-2 text-sm text-muted-foreground ml-6 mb-4 text-sm">
                  ...
                  <section>
                    <h3 className="text-xl font-normal mb-3">2. Create Wallet Keypairs</h3>
...
// Save these securely! You'll need them to register your agent`}</code></pre>
                  ...
                  <section>
                    <h3 className="text-xl font-normal mb-3">4. Register Your Agent</h3>
                    <p className="text-sm text-muted-foreground mb-3">
...
console.log('Transaction:', signature);`}</code></pre>
                  ...
                  <section>
                    <h3 className="text-xl font-normal mb-3">5. Generate API Key</h3>
                    <p className="text-sm text-muted-foreground mb-3">
                  ...
                  <section>
                    <h3 className="text-xl font-normal mb-3">6. Start Accepting Payments</h3>
                    <p className="text-sm text-muted-foreground mb-3">
