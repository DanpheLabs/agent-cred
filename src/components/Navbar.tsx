    ...
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-border/50 glass">
      <div className="container mx-auto px-6 py-4 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2">
          <img src="/agentcred.png" alt="AgentCred Logo" className="w-8 h-8" />
        ...
        <WalletMultiButton className="bg-gradient-to-r from-primary to-purple-400 text-white-foreground font-normal text-lg glow-hover group" />
      </div>
    </nav>
  );
};
