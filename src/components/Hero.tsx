  ...
  return (
    <section className="flex items-center justify-center px-4 sm:px-6 py-16 sm:py-24">
      <div className="container mx-auto text-center max-w-4xl">
        ...
        {/* Title */}
        <h1 className="text-3xl sm:text-4xl md:text-6xl font-normal mb-6 leading-tight text-balance break-words">
          Most Secure {" "} 
          <span className="gradient-text">Autonomous Wallet</span> Infrastructure
        </h1>

        {/* Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2  glass border border-primary/20 mb-6">
        ...
        {/* Description */}
        <p className="text-md sm:text-lg text-muted-foreground mb-10 max-w-2xl mx-auto px-2">
          ...
          {[
            ...
            <div key={index} className="glass p-6  glow-hover">
              ...
              <p className="text-muted-foreground">{feature.description}</p>
                  ...
                  <div className="mt-16 glass p-8  border-border/50 text-center">
            ...
            <div className="flex gap-4 justify-center">
              <a 
                href="/sdk" 
                className="px-6 py-3  bg-gradient-to-r from-primary to-green-400 text-primary-foreground font-normal glow-hover inline-block"
              >
                View SDK
              </a>
              <a 
                href="/docs" 
                className="px-6 py-3  glass border-border/50 hover:border-primary/50 font-normal inline-block"
              >
                Read Docs
              </a>
            </div>
